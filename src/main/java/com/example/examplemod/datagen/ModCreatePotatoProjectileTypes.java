...
public class ModCreatePotatoProjectileTypes {
    ...
    public static void bootstrap(BootstrapContext<PotatoCannonProjectileType> context) {
        context.register(POMEGRANATE, new PotatoCannonProjectileType.Builder().build());
        context.register(EXPLOSIVE_POMEGRANATE, new PotatoCannonProjectileType.Builder().build());
        context.register(COCONUT, new PotatoCannonProjectileType.Builder().build());
        context.register(HEAVY_COCONUT, new PotatoCannonProjectileType.Builder().build());
